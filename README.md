...
- Grupp(Max 3 pers, alt ensam)
	...
	Du skall kunna göra transaktioner till andra användare med dina "bitcoins".
...
Jag testade mig fram och lyckades göra en loop som sökte igenom min .txt fil för att se ifall användare existerar.
Ifall användar-id eller password är fel, får personen försöka igen.
 
Om användare inte är registrerad får användare frågan om de vill registrera sig eller inte
...
skriver användaren 'No'  printas det  ut ”good boy”.
skriver användaren ’Yes’ så får användaren skriva in username hos personen den vill föra över pengar till.
När användarnamnet väl skrivits in söker programmet igenom ifall username har ett lösenord (som man får välja när man registrerar sig). Om det inte finns ett lösenord hos det angivna username som användare skrev in säger programmet till att det inte finns en sådan användare och att han får försöka igen.
För att testa detta finns det en användare under namnet ”monalisa” som ej har ett lösenord som du kan försöka överföra pengar till.
